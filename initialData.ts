...
// Helper to create consistent, deterministic image URLs for the catalog
const createImageUrl = (seed: string) => `https://picsum.photos/seed/${seed}/200`;

// New structure: A record where keys are phrase IDs
export const MASTER_IMAGE_CATALOG: Record<string, CatImage[]> = {
  'yes': [
...
// Defines which images are unlocked at the very beginning of the game.
export const INITIAL_UNLOCKED_IMAGE_IDS: string[] = [];

// Helper to get all images in a flat array for easier processing
export const ALL_IMAGES_FLAT = Object.values(MASTER_IMAGE_CATALOG).flat();